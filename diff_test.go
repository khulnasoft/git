				...
				Lines: []*DiffLine{
					{
						...
						Type:      DiffLineAdd,
						Content:   `+[submodule "khulnasoft/docs-api"]`,
						LeftLine:  0,
						RightLine: 1,
					}, {
						Type:      DiffLineAdd,
						Content:   `+	path = khulnasoft/docs-api`,
						LeftLine:  0,
						RightLine: 2,
					},
				},
...
+++ b/.gitmodules
@@ -0,0 +1,3 @@
+[submodule "khulnasoft/docs-api"]
+	path = khulnasoft/docs-api
+	url = https://github.com/khulnasoft/docs-api.git
diff --git a/khulnasoft/docs-api b/khulnasoft/docs-api
new file mode 160000
index 0000000..6b08f76
--- /dev/null
+++ b/khulnasoft/docs-api
@@ -0,0 +1 @@
								...
								Lines: []*DiffLine{
									{
										...
										Type:      DiffLineAdd,
										Content:   `+	url = https://github.com/khulnasoft/docs-api.git`,
										LeftLine:  0,
										RightLine: 3,
									},
								},
